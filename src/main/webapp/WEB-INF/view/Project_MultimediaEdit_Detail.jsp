...
<body>
      ...
      <div class="header">
        <div class="now color"><a href="../../back/index"  class="color">后台</a> -> 项目案例 -> 多媒体会议</div>
      </div>
      <div class="flatmain">
        ...
        <div class="sform3">
            <ul>
              ...
              <li>
                ...
                <div class="gill"><input  class="contactinputs" name="title" value="${proMulti.title }" type="text" id="title">
                </div>
...
$(function(){
    ...
    $("#change").on("click",function(){
		...
		var id = 1;
		if ("${proMulti.mid ==''}") {
			id = parseInt("${proMulti.mid }");
		}
        var obj = {"mid":id,"title":title,"introduciton":content};
