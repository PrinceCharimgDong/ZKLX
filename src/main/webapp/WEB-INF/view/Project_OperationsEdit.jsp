...
<body>		<jsp:include page="backnav.jsp">
      ...
      <div class="search"> <a class="style1">查询</a>
        <div class="sform">
            ...
            <div class="lastceng"><input name="input" id="ptitle" type="text"  class="inputh">
            </div>
                    
            <input class="bottons c_blue" name="input" type="submit" value="查询" onClick="selectByTitle();">
        </div>
      </div>
      <div class="list">
      <a class="style1">IT运维案例</a>
        <div class="listbox">
		   ...
		   <%inString = request.getAttribute("intro") ;%>
                  <tr>
                    ...
                    <td>
                    	<input type="button" value="编辑" class="bottons c_qing" onclick="location.href='update?id=${item.aid}'">
                        <input type="button" value="删除" class="bottons c_red" onClick="alert_del(${item.aid})">
                    </td>
                  </tr>
                    </c:forEach>
