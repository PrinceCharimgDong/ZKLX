...
<body>
      ...
      <div class="list">
      <a class="style1">产品列表</a>
        <div class="listbox">
            
            <div class="buttonbox">
                <input type="button" value="添加" class="bottons c_green" onClick="window.location.href='subadd?belongid=${belongid}'">
            ...
            <div class="tablemain">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td><a href="detail?bid=${item.pid}" class="color1">${item.pname }</a></td>
                    <td>2018-05-21 05:23:56</td>
                    <td>2018-05-21 05:23:56</td>
                    <td>
                    	<input type="button" value="编辑" class="bottons c_qing"  onclick="location.href='subupdate?id=${item.pid}&belongid=${belongid }'">
