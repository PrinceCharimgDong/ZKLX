...
<c:if test="${state.equals('update')}">update?id=${solution.lid }</c:if> " enctype="multipart/form-data"  method="post">
标题:<input type="text" name ="title"  value="${solution.title }"/><br/>
网址:<input type="text" name ="website"  value="${solution.website }"/><br/>
