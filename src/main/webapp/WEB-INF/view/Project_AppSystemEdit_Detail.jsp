...
<body>
      ...
      <div class="header">
        <div class="now color"><a href="../../back/index"  class="color">后台</a> -> 项目案例 -> 应用系统</div>
      </div>
      <div class="flatmain">
        ...
        <div class="sform3">
            <ul>
              ...
              <li>
                ...
                <div class="gill"><input  class="contactinputs" name="title" value="${proApp.title }" type="text" id="title">
                </div>
