...
<body>
	<jsp:include page="backnav.jsp">
      ...
      <div class="banneraddmain">
     	 <a class="style1">添加云终端产品</a>
         <div class="contactbox1">
        	<div class="sform2">
            <ul>
              <form action="<c:if test="${state.equals('save')}">subsave?belongid=${belongid }</c:if>
<c:if test="${state.equals('update')}">subupdate?id=${productSub.pid }&belongid=${belongid }</c:if>"  id="sysForm" method="post">
              <li>
                <div class="fll1">产品名称<strong class="red">*</strong></div>
                <div class="gill"><input  class="contactinputs" value="${productSub.pname }" name="pname" type="text" id="title">
                </div>
