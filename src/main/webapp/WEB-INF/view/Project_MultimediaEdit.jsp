...
<body>
    	...
    	<jsp:param value="5.2" name="number2"/>
  	</jsp:include>
      <div class="header">
            ...
            <div class="tablemain">
                <table width="100%">
                  ...
                  <tr>
					...
					<jsp:setProperty name="dateValue" property="time" value="${item.mid}"/>
					<fmt:formatDate value="${dateValue}" pattern="yyyy/MM/dd HH:mm:ssss"/></td>
                    </td>
                    <td>
                    	<input type="button" value="编辑" class="bottons c_qing" onclick="location.href='update?id=${item.mid}'">
                        <input type="button" value="删除" class="bottons c_red" onClick="alert_del(${item.mid})">
                    </td>
                  </tr>
                   </c:forEach>
                </table>
