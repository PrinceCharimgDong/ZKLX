        ...
        <div class="listbox">
                  ...
                  <tr>
                    ...
                    <th width="20%" scope="col">操作</th>
                       ...
                       <c:forEach var="item" items="${list}" varStatus="xh">
			 		   <c:set var="intro" value="${item.scontext}" scope="request"/>
			 		   <%  Object inString;
		   ...
		   <%inString = request.getAttribute("intro") ;%>
                  <tr>
                    ...
                    <td>
                    	<input type="button" value="编辑" class="bottons c_qing" onclick="location.href='update?id=${item.lid}'">
                        <input type="button" value="删除" class="bottons c_red" onClick="alert_del(${item.lid})">
                    </td>
                  </tr>
                  </c:forEach>
