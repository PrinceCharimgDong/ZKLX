...
<body>
    	...
    	<jsp:param value="1.4" name="number2"/>
  	</jsp:include>
      <div class="header">
        <div class="now color"><a href="../../back/index" class="color">后台</a> -> 网站首页 -> 解决方案</div>
      </div>
      
      <div class="logomain">
      <a class="style1">添加解决方案</a>
      <div class="sform3">
            <ul>
              <form action="<c:if test="${state.equals('save')}">save</c:if>
		<c:if test="${state.equals('update')}">update?id=${solution.lid}</c:if>" class="container" enctype="multipart/form-data" method="post" id='sysForm'>
              <li>
                <div class="fll1">标题<strong class="red">*　　</strong></div>
                <div class="gill"><input  class="contactinputs" name="title" value="${solution.title }" type="text" id="title">
                </div>
                
              </li>
               <li>
                <div class="fll1">网址<strong class="red">*　　</strong></div>
                <div class="gill"><input  class="contactinputs" name="website" value="${solution.website }" type="text" id="title">
                </div>
